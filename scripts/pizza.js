...
function getReceipt() {
    ...
    if (selsectedSize === "Personal Pizza") {
        sizeTotal = 6;
    ...
    else if (selectedSize === "28in World Famous Pizza") {
        sizeTotal = 24;
        text2 = text2 + sizeTotal + "<br>";
    }
...
function getVeggie(runningTotal, text1, text2) {
    ...
    for (var j = 0; j < veggieArray.lenght; j++) {
...
function getCheese(runningTotal, text1, text2); {
    ...
    for (var j = 0; j < cheeseArray.lenght; j++) {
...
function getCrust(runningTotal, text1, text2) {
    ...
    for (var j = 0; j < crustArray.length; j++) {
        if (crustArray[j].checked) {
            selectedCrust = crustArray[j].valve;
